		...
		<div class="id1">
			<form action="login" method="post"
				...
				<table cellspacing="2">
					...
					<tr>
						<td><div id="email_error" style="display: none; color: red;">Email
								Id cannot be empty</div></td>
					</tr>
					<tr>
					...
					<tr>
						<td><div id="password_error"
								style="display: none; color: red;">Password cannot be
								empty</div></td>
					</tr>
					<tr>
